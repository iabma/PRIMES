...
\begin{document}
	...
	\begin{flushleft}
		...
		\begin{enumerate}
			...
			\subparagraph{\textit{Solution}} Let $t_i$ be the expected amount of time for the ant to reach vertex 8 from vertex $i$ on the cube.
		...
		\begin{enumerate}
			...
			\subparagraph{\textit{Solution}} When put through a program I wrote (included in my CS .zip file), I discovered several small number solutions. 
